...
Peffers et al. (2007): problem identification, objectives, design and
...
formulation (Rezaei, 2016) is used, giving a unique solution.
...
Section 5.3: an AUC of 0.97 was investigated rather than reported, and proved to
