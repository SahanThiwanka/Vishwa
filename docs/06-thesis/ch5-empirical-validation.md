...
the data — and §5.3.5 rules it out.
...
justified in §4.3.2 on Arvanitis, Stampini and Vencatachellum (2015), who report
that development and credit concerns in development-bank appraisal are "rather
independent from each other".

As §2.6.2 sets out, their evidence is a *positive but non-significant*
...
longer available. §5.6b.2 sets out why the design decision nevertheless stands,
...
hypothesis was therefore tested directly rather than inferred, and §5.6d reports
what that test found — which is the opposite.

## 5.6d What the models do with information the applicant did not supply

§4.5 reported a completeness gate: the artefact refuses to return a band when too
...
threshold is the same portfolio rule as §5.6c — decline the riskiest 20%, which
on these applicants falls at a predicted default probability of **0.2293**.
§5.6d.3 shows the conclusion does not depend on that choice.
...
The completeness gate was justified in §4.5 on safety grounds: a score computed
